...
const whitepapper = [
  ...
  },
  {
    ...
    body: [
      {
        subtitle: "3.1 Smart Contracts",
        text1:
          "Smart contracts are a fundamental component of the AQORDS platform, enabling the execution and automation of contractual agreements between parties involved in freight transportation. These self-executing contracts are powered by blockchain technology, ensuring transparency, immutability, and security. ",
        text2:
      ...
      },
      {
        ...
        text1:
          "AQORDS integrates decentralized finance (DeFi) concepts into its platform, unlocking new possibilities for participants in the freight transportation industry. DeFi enables the creation of financial instruments and services that operate without centralized intermediaries, providing greater financial inclusivity, accessibility, and efficiency.",
        text2:
      ...
      },
      {
        ...
        text1:
          "The track-and-trace functionality of the AQORDS platform enables real-time visibility and monitoring of shipments throughout the entire transportation process. By leveraging blockchain technology, AQORDS creates an immutable and transparent record of each step, from loading to delivery.",
        text2:
      ...
      {
        subtitle: "3.4 Dispute Resolution Mechanisms",
        text1:
          "Disputes are an inherent part of any industry, including freight transportation. AQORDS tackles this challenge by implementing automated dispute resolution mechanisms powered by smart contracts. Disputes can be resolved more efficiently and fairly through predefined rules and conditions encoded in the smart contracts.",
        text2:
          "Participants can track the movement of goods, verify their condition, and ensure adherence to predefined criteria. The track-and-trace functionality enhances supply chain efficiency, reduces delays, and enables proactive decision-making based on accurate and up-to-date information.",
        text3: null,
        text4: null,
      ...
      },
      {
        ...
        text1:
          "Data privacy and security are paramount in the freight transportation industry, which handles sensitive information and valuable assets. AQORDS prioritizes the protection of data by leveraging blockchain's inherent security features. The platform ensures that confidential information is encrypted, tamper-proof, and accessible only to authorized participants",
        text2:
  ...
  },
  {
    ...
    body: [
      {
        subtitle: "4.1 Shippers",
        text1:
          "Shippers benefit from the AQORDS platform by experiencing streamlined contract execution and payments. Through smart contracts, shippers can automate payment terms, ensuring timely and accurate transactions. ",
        text2:
      ...
      },
      {
        ...
        text1:
          "Carriers gain numerous advantages by leveraging the AQORDS platform. One significant benefit is the ability to receive prompt payments upon delivery. Unlike traditional payment cycles that can take weeks or even months, AQORDS enables instant payment settlement, improving cash flow and overall financial stability for carriers.",
        text2:
      ...
      },
      {
        ...
        text1:
          "Freight exchanges play a vital role in connecting shippers and carriers, and AQORDS provides seamless integration with these platforms. By incorporating AQORDS smart contracts into freight exchanges, participants can benefit from automated contract execution, instant payments, and enhanced transparency.",
        text2:
      ...
      },
      {
        ...
        text1:
          "The benefits of AQORDS extend beyond shippers and carriers to include various supply chain partners. From freight forwarders to customs agents and warehouse operators, these partners can leverage AQORDS to streamline their operations, enhance visibility, and improve collaboration.",
        text2:
          " AQORDS facilitates seamless information exchange, reducing administrative burdens and enabling real-time data sharing. Supply chain partners can access accurate and up-to-date information about shipments, improving coordination, and optimizing overall supply chain performance.",
        text3:
  ...
  },
  {
    ...
    body: [
      {
        subtitle: "5.1 Integration with Existing Systems",
        text1:
          "The successful implementation of AQORDS relies on seamless integration with existing systems and platforms within the freight transportation industry. AQORDS is designed to be compatible with various software applications, including freight management systems, supply chain management platforms, and freight exchange marketplaces. ",
        text2:
      ...
      },
      {
        ...
        text1:
          "Collaboration and partnership are crucial elements in the AQORDS ecosystem. We actively seek collaborations with shippers, carriers, freight exchanges, and other stakeholders to foster a vibrant and interconnected network. By collaborating with industry leaders and innovative startups, we aim to create a robust ecosystem that enhances the value and functionality of AQORDS.",
        text2:
  ...
  },
  {
    ...
    body: [
      {
        subtitle: "6.1 The QOR Token",
        text1:
          "The native utility token of the AQORDS ecosystem is the QOR token. It serves as the primary means of value exchange within the platform. With the QOR token, users can pay for transaction fees, access premium features, participate in governance decisions, and enjoy various incentives and rewards.",
        text2:
      ...
      },
      {
        ...
        text1:
          "The QOR Token lies at the heart of the AQORDS ecosystem, providing users with access to a range of premium features and incentives. Our tokenomics model ensures a balanced token supply while fostering platform growth, community engagement, and long-term value.",
        text2: null,
        text3: null,
        text4: null,
        underlist: [
