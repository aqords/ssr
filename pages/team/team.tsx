      ...
      <div className="md:bg-[#19191A] md:py-[120px] py-[30px]">
        <div className="container flex flex-wrap md:flex-nowrap  justify-center  md:jutify-between gap-[40px] md:gap-[112px] mb-[40px]">
          <div className="max-w-[532px]">
            <p className="font-man leading-[31px] tracking-[-0.14px] md:text-[20px]">
              ...
              the freight transportation space, our team is committed to
              developing innovative solutions that transform the way contracts
              are executed, payments are processed, and trust is established
              between parties.
            </p>
            <br />
            <p className="font-man text-[#838383] text-[15px] leading-[24px] tracking-[-0.14px] md:text-[18px]">
              We are dedicated to creating a culture of excellence, innovation,
              and continuous learning within AQORDS. Our team is fueled by a
              passion for disruptive technologies and a commitment to delivering
        ...
        <div className="container">
          <p className="font-man md:text-[20px] leading-[24px] tracking-[-0.14px] mb-[30px]">
            Together, we are shaping the future of freight transportation and
            unlocking new possibilities for the industry.
          </p>
          <p className="font-man text-[#838383]  text-[15px] leading-[24px] tracking-[-0.14px]">
            Join us on this exciting journey as we revolutionize the way supply
            chains operate and pave the way for a more efficient, transparent,
            and secure future.
          </p>
        </div>
      </div>
