  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        search: "0px 32px 24px -30px rgba(0, 0, 0, 0.09)",
        popup: "-30px 34px 140px -40px rgba(0, 0, 0, 0.8)",
        results: "0px 40px 90px 40px rgba(0, 0, 0, 0.11)",
        error: "-30px 78px 144px -116px rgb(126,126,126)",
        errorIcon: "0px 14px 20px -12px rgba(0, 0, 0, 0.2)",
        searchBtn: "0px 12px 12px -2px rgba(0, 0, 0, 0.08);",
      },
      backgroundColor: {
        "white-1": "#F8F9FB",
        "c-gray": "#686B6F",
